...
const channelRoutesOffchain = require('../routes/channelOffchain')
const channelCreateOffchain = require('../routes/channelCreateOffchain')
const analyticsV5Offchain = require('../routes/analyticsV5Offchain')
...
app.use('/v5_a/channel', channelRoutesOffchain)
app.use('/v5_a/channel', channelCreateOffchain.forAdapter(adapter))
app.use('/v5_a/analytics', analyticsV5Offchain)
