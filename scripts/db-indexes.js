...
db.analyticsAggregate.createIndex({ channelId: 1 })
db.analyticsAggregate.createIndex({ created: 1 })
db.analyticsAggregate.createIndex({ channelId: 1, created: 1 })
db.analyticsAggregate.createIndex({ earners: 1, created: 1 })
